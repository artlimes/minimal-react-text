...
var _componentsMinimalTextfield = require('./components/MinimalTextfield');

var _componentsMinimalTextfield2 = _interopRequireDefault(_componentsMinimalTextfield);

_reactDom2['default'].render(_react2['default'].createElement(
  'div',
  null,
  _react2['default'].createElement(_componentsMinimalTextfield2['default'], { label: 'Label' }),
  _react2['default'].createElement(_componentsMinimalTextfield2['default'], { label: 'Label', placeholder: 'Placeholder' }),
  _react2['default'].createElement(_componentsMinimalTextfield2['default'], { label: 'Label', placeholder: 'Placeholder', inputValue: 'InputValue' }),
  _react2['default'].createElement(_componentsMinimalTextfield2['default'], { label: 'Label', isRequired: true }),
  _react2['default'].createElement(_componentsMinimalTextfield2['default'], { label: 'Label', placeholder: 'Placeholder', isDisabled: true }),
  _react2['default'].createElement(_componentsMinimalTextfield2['default'], { label: 'Label', type: 'textarea' }),
  _react2['default'].createElement(_componentsMinimalTextfield2['default'], { label: 'Label', type: 'textarea', textareaLarge: true })
), document.getElementById('example'));

},{"./components/MinimalTextfield":2,"react":undefined,"react-dom":undefined}],2:[function(require,module,exports){
(function (process){
'use strict';
...
var MinimalTextfield = (function (_Component) {
  _inherits(MinimalTextfield, _Component);

  function MinimalTextfield(props) {
    _classCallCheck(this, MinimalTextfield);

    _get(Object.getPrototypeOf(MinimalTextfield.prototype), 'constructor', this).call(this, props);
...
exports['default'] = MinimalTextfield;
